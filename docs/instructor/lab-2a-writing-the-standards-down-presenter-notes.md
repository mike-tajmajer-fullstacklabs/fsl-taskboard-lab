...
## Slide 2 · Two hours, mostly hands-on  *(Today)*
...
## Slide 3 · Sixteen developers, sixteen private setups  *(Why)*
...
## Slide 4 · Every rule has a reach — that reach is its layer  *(Scope)*
...
## Slide 5 · Five types — and the question each answers  *(The Artifacts)*
...
## Slide 6 · One subject, five artifacts  *(Differentiation)*
...
## Slide 7 · Telling them apart when it is unclear  *(Differentiation)*
...
## Slide 8 · How big should it get?  *(Claude.Md)*
...
## Slide 9 · Start light — and know when to graduate  *(Maturity)*
...
## Slide 10 · When is a document required — and who owns it?  *(Authoring)*
...
## Slide 11 · Drafting with Claude, honestly  *(Authoring)*
...
## Slide 12 · Keeping them true  *(Lifecycle)*
...
## Slide 14 · A rule with no recorded reason  *(Demo · The Gap)*
...
## Slide 15 · Six steps — follow along on screen  *(Demo · The Steps)*
...
## Slide 16 · What good looks like  *(Demo · The Result)*
...
## Slide 17 · Now write yours — same subject, your words  *(Your Turn)*
...
## Slide 18 · Checkpoint 1  *(Checkpoint)*
...
## Slide 20 · Three ways the same bug got fixed  *(Stimulus)*
...
## Slide 21 · Your ten minutes, structured  *(Derive · The Clock)*
...
## Slide 22 · Which are acceptable? Write the rule.  *(Derive)*
...
## Slide 23 · Where we landed  *(Converge)*
...
## Slide 24 · Same file, three enforcement states  *(The Hinge)*
...
## Slide 25 · What a mature team wrote  *(Compare)*
...
## Slide 26 · Turn the clauses into an NFR  *(Write It Up)*
...
## Slide 27 · Checkpoint 2  *(Checkpoint)*
...
## Slide 28 · A document nothing points at is a document nobody reads  *(Wire It In)*
...
## Slide 29 · Compare, reflect, capture  *(Review & Retro)*
...
## Slide 30 · Ship checklist, and what is next  *(Wrap)*
